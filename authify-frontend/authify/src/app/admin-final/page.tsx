...
import { Shield, Users, Settings, FileText, Lock, Bell, Monitor, LogOut, Menu, X } from 'lucide-react';
      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-16'} bg-gray-800 border-r border-gray-700 flex flex-col transition-all duration-300`}>
        ...
        <nav className="flex-1 p-2 overflow-y-auto">
          <div className="space-y-1">
            {[
              { id: 'dashboard', label: 'Dashboard', icon: () => <div className="w-5 h-5 bg-blue-500 rounded" /> },
              { id: 'users', label: 'User Management', icon: () => <div className="w-5 h-5 bg-green-500 rounded" /> },
              { id: 'roles', label: 'Roles & Permissions', icon: () => <div className="w-5 h-5 bg-purple-500 rounded" /> },
              { id: 'auth', label: 'Authentication Settings', icon: () => <div className="w-5 h-5 bg-orange-500 rounded" /> },
              { id: 'logs', label: 'Login & Activity Logs', icon: () => <div className="w-5 h-5 bg-red-500 rounded" /> },
              { id: 'settings', label: 'System Settings', icon: () => <div className="w-5 h-5 bg-gray-500 rounded" /> },
            ].map((item) => (
              <button
                key={item.id}
