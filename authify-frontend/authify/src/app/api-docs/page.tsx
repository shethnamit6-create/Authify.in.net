    ...
    <div className="flex flex-col min-h-screen bg-white">
      <header className="px-8 h-20 flex items-center justify-between border-b bg-white sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/dashboard">
            <Button size="sm">Developer Console</Button>
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-4">
        ...
        <div className="md:col-span-3 p-8 md:p-12 space-y-16 animate-fade-in">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-bold text-primary">Cross-Platform SDK Support</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {['Node.js', 'React', 'iOS Swift', 'Android', 'Go', 'Python', 'Flutter', 'Ruby'].map((sdk) => (
                <div key={sdk} className="flex items-center justify-between p-4 rounded-xl border bg-white hover:border-primary transition-colors cursor-pointer group">
                  <span className="font-medium text-sm">{sdk}</span>
